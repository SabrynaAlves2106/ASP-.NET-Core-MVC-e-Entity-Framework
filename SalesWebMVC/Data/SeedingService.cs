...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            {
                return; //O banco de dados já foi populado com as informações recebidas
            }
            Departament d1 = new Departament(new int(), "Computers");
            Departament d2 = new Departament(new int(), "Electronics");
            Departament d3 = new Departament(new int(), "Fashion");
            Departament d4 = new Departament(new int(), "Books");

            Seller s1 = new Seller(new int(), "Bob Brown", "bob@gmail.com", new DateTime(1998, 4, 21), 1000, d1);
            Seller s2 = new Seller(new int(), "Maria Green", "maria@gmail.com", new DateTime(1979, 12, 31), 3500, d2);
            Seller s3 = new Seller(new int(), "Alex Grey", "alex@gmail.com", new DateTime(1988, 1, 15), 2200, d1);
            Seller s4 = new Seller(new int(), "Martha Red", "martha@gmail.com", new DateTime(1993, 11, 30), 3000, d4);
            Seller s5 = new Seller(new int(), "Donald Blue", "donald@gmail.com", new DateTime(2000, 1, 9), 4000, d3);
            Seller s6 = new Seller(new int(), "Alex Pink", "bob@gmail.com", new DateTime(1997, 3, 4), 3000, d2);
            Seller s7 = new Seller(new int(), "Sabryna Alves", "Sabryna@gmail.com", new DateTime(2000, 6, 21), 3000, d2);
            ...
            SalesRecord r3 = new SalesRecord(new int(), new DateTime(2018, 09, 13), 4000.0, SaleStatus.Cancel, s4);
            ...
            SalesRecord r23 = new SalesRecord(new int(), new DateTime(2018, 10, 19), 11000.0, SaleStatus.Cancel, s2);
